...
<body>
    ...
    <div class="container container-body">
        ...
        <div class="row">
            <div onclick="fireSwaltar('Bot',10)" class="col-7 grid-img-2" style="background-image: url(../../../src/imgs/sitios/bosqueT/11.jpg);">
            </div>
            <div onclick="fireSwaltar('Bot',11)" class="col-5 grid-img-2" style="background-image: url(../../../src/imgs/sitios/bosqueT/12.jpg);">
            </div>
        </div>
        <div class="space"></div>
        <h2>Ubicación</h2>
