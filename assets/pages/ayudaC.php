...
<body>
    ...
    <div class="container-lg container-fluid container-body">
        <h1>¡AYÚDANOS A CONSERVAR!</h1>
        <p class="text-goth sub-sub">Todas y todos cuidamos las Áreas Naturales Protegidas</p>
        <br>
        <p class="text-para">Usualmente las Áreas Naturales Protegidas de la ciudad suelen ser confundidas con Parques Urbanos, donde las comunidades cercanas y visitantes al no identificar dicha diferencia y desconocer su importancia realizan actividades no permitidas que ponen en riesgo su protección y preservación.</p>
        <p class="text-para">El deterioro de espacios naturales representa la pérdida de biodiversidad, ya que, las Áreas Naturales Protegidas de la ciudad son el hábitat de especies de flora y fauna endémicas, nativas y categorizadas en la <b>NOM-059-SEMARNAT-2010</b> que contribuyen a la captación de agua de lluvia, captura de carbono, purificación del aire, generación de suelo y regulación del clima, así como forma parte del patrimonio cultural e identitario de nuestra nación.</p>
        <p class="text-para">Por ello, es imprescindible su preservación y tu puedes ayudar convirtiéndote en un Visitante Verde de las Áreas Naturales Protegidas cuando:</p>
        <br />
            ...
            <div class="row">
                <div class="col-sm">
                    <center>
                        ...
                        <img src="../../src/imgs/ayu/8.svg" class="img-ind"><br /><br />
                        <img src="../../src/imgs/ayu/9.svg" class="img-ind"><br /><br />
                        <img src="../../src/imgs/ayu/10.svg" class="img-ind"><br /><br />
                        <img src="../../src/imgs/ayu/11.svg" class="img-ind"><br /><br />
                        <img src="../../src/imgs/ayu/12.svg" class="img-ind"><br /><br />
                        <img src="../../src/imgs/ayu/13.svg" class="img-ind">
                    </center>
                </div>
                <div class="col-sm-9">
                    <br />
        ...
        <br />
        <p>Las reglas pertenecen a las prohibiciones presenten en los programas de manejo de cada una de las Áreas Naturales Protegidas, las cuales tienen el objetivo de proteger y conservar los recursos naturales.</p>
        <div class="space"></div>
        <div class="row">
            <div onclick="fireSwal(0);" class="col-6 grid-img-3" style="background-image: url(../../../src/imgs/ayu/1.jpg);">
            </div>
            <div onclick="fireSwal(1);" class="col-6 grid-img-3" style="background-image: url(../../../src/imgs/ayu/2.jpg);">
            </div>
        </div>
